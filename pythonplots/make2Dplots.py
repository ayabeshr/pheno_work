...
# Xsection Vs M12
xsc_Vsm12 = df.plot(x = "mbreaking", y = "new_xsc(pb)", marker = ".", color = "blue", label =  "$\sigma (pb)$ \n at tree-level", linestyle="")
plt.grid(True)
...
xsc_Vschi = df.plot(x = "csqr_total", y = "new_xsc(pb)", marker = ".", fillstyle=None, color = "red", label =  "$\sigma (pb)$ \n at tree-level", linestyle="")
plt.grid(True)
plt.xlabel(r"$\chi^{2}$")
plt.ylabel(r"$\sigma(pb)(gg \rightarrow H \rightarrow hh \rightarrow bb4Mu) x 10^{-8}$")
plt.legend(loc="upper left")
...
# H2 mass Vs M12 
h2mass_Vsm12 = df.plot(x = "mbreaking", y = "mH(GeV)", marker = ".", color = "green", linestyle="")
plt.grid(True)
plt.xlabel(r"$M_{12}^{3}$")
plt.ylabel("H_mass(GeV)")

# Xsection Vs H2 mass 
xsc_Vsh2mass = df.plot(x = "mH(GeV)", y = "new_xsc(pb)", marker = ".", color = "magenta", label =  "$\sigma (pb)$ \n at tree-level", linestyle="")
plt.grid(True)
