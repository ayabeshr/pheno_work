...
// Tue Jul 19 04:56:47 2022 by ROOT version 6.18/04
// from TChain Delphes/
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 4282;
   static constexpr Int_t kMaxGenJet = 16;
   static constexpr Int_t kMaxGenMissingET = 1;
   static constexpr Int_t kMaxEFlowTrack = 231;
   static constexpr Int_t kMaxEFlowPhoton = 299;
   static constexpr Int_t kMaxEFlowNeutralHadron = 184;
   static constexpr Int_t kMaxPhoton = 15;
   static constexpr Int_t kMaxElectron = 4;
   static constexpr Int_t kMaxMuonLoose = 10;
   static constexpr Int_t kMaxMuonTight = 10;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("/media/aya/PACKUP/Aya/final_analysis/inputs/ZZ4Mu.root/Delphes");
      chain->Add("/media/aya/Aya/final_analysis/inputs_20220630/qqZZTo4Mu_LO_14TeV_Phase2_run02_300kEvn_rndseed-37.root/Delphes");
      chain->Add("/media/aya/Aya/final_analysis/inputs_20220630/qqZZTo4Mu_LO_14TeV_Phase2_run03_100kEvn_rndseed-42.root/Delphes");
      chain->Add("/media/aya/Aya/final_analysis/inputs_20220630/qqZZTo4Mu_LO_14TeV_Phase2_run04_100kEvn_rndseed-24.root/Delphes");
      chain->Add("/media/aya/Aya/final_analysis/inputs_20220630/qqZZTo4Mu_LO_14TeV_Phase2_run06_200kEvn_rndseed-83.root/Delphes");
      chain->Add("/media/aya/Aya/final_analysis/inputs_20220630/qqZZTo4Mu_LO_14TeV_Phase2_run07_150kEvn_rndseed-24.root/Delphes");
      chain->Add("/media/aya/Aya/final_analysis/inputs_20220630/qqZZTo4Mu_LO_14TeV_Phase2_run08_150kEvn_rndseed-69.root/Delphes");
      tree = chain;
#endif // SINGLE_TREE
