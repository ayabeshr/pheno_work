...
// used to generate this class and read the Tree.
   if (tree == 0) {
    ...
    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/media/aya/PACKUP/Aya/final_analysis/inputs_20220517/sig_New_Scan20220605_BMP3_Eta2-8_10kEv_PhaseII_NoPU_LO.root");
     ...
     // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/media/aya/PACKUP/Aya/final_analysis/inputs_20220517/HTo4Mu_MaxEta_PhaseII_NoPU_NLO.root");
      ...
      if (!f || !f->IsOpen()) {
        ...
        // f = new TFile("/media/aya/PACKUP/Aya/final_analysis/inputs_20220517/sig_New_Scan20220605_BMP2_Eta2-8_10kEv_PhaseII_NoPU_LO.root");
         f = new TFile("/media/aya/PACKUP/Aya/final_analysis/inputs_20220517/sig_New_Scan20220605_BMP3_Eta2-8_10kEv_PhaseII_NoPU_LO.root");
