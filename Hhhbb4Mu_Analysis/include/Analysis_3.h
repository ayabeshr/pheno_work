...
// Thu Jul 21 13:20:52 2022 by ROOT version 6.18/04
// from TChain Delphes/
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 4669;
   static constexpr Int_t kMaxGenJet = 21;
   static constexpr Int_t kMaxGenMissingET = 1;
   static constexpr Int_t kMaxEFlowTrack = 279;
   static constexpr Int_t kMaxEFlowPhoton = 311;
   static constexpr Int_t kMaxEFlowNeutralHadron = 201;
   static constexpr Int_t kMaxPhoton = 22;
   static constexpr Int_t kMaxElectron = 6;
   static constexpr Int_t kMaxMuonLoose = 11;
   static constexpr Int_t kMaxMuonTight = 11;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("/media/aya/PACKUP/Aya/final_analysis/inputs/TTZTobb4Mu_LO_20220422.root/Delphes");
      chain->Add("/media/aya/Aya/final_analysis/inputs_20220630/qqTTZTobb4Mu_LO_14TeV_Phase2_run02_300kEvn_rndseed-57.root/Delphes");
      chain->Add("/media/aya/Aya/final_analysis/inputs_20220630/qqTTZTobb4Mu_LO_14TeV_Phase2_run03_300kEvn_rndseed-37.root/Delphes");
      chain->Add("/media/aya/Aya/final_analysis/inputs_20220630/qqTTZTobb4Mu_LO_14TeV_Phase2_run04_200kEvn_rndseed-29.root/Delphes");
      tree = chain;
#endif // SINGLE_TREE
