...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   h_Gen_Muons_eta = new TH1D("h_Gen_Muons_eta", "h_Gen_Muons_eta", 40, -10., 10.);
   h_Gen_Muons_eta->GetXaxis()->SetTitle("#eta");
   h_Gen_Muons_eta->GetYaxis()->SetTitle("Number of Events");
   
   h_Gen_Muons_phi = new TH1D("h_Gen_Muons_phi", "h_Gen_Muons_phi", 40, -10., 10.);
   ...
   h_Gen_Bjet_eta = new TH1D("h_Gen_Bjet_eta", "h_Gen_Bjet_eta", 40, -10., 10.);
   h_Gen_Bjet_eta->GetXaxis()->SetTitle("#eta");
   h_Gen_Bjet_eta->GetYaxis()->SetTitle("Number of Events");
   
   h_Gen_Bjet_phi = new TH1D("h_Gen_Bjet_phi", "h_Gen_Bjet_phi", 40, -10., 10.);
   ...
   h_eta_Za = new TH1D("h_eta_Za", "h_eta_Za", 64, -8., 8.); 
   h_eta_Za->GetXaxis()->SetTitle("#eta");
   h_eta_Za->GetYaxis()->SetTitle("Number of Events");
   
   h_phi_Za = new TH1D("h_phi_Za", "h_phi_Za", 40, -10., 10.); 
   ...
   h_eta_Zb = new TH1D("h_eta_Zb", "h_eta_Zb", 64, -8., 8.); 
   h_eta_Zb->GetXaxis()->SetTitle("#eta");
   h_eta_Zb->GetYaxis()->SetTitle("Number of Events");
   
   h_phi_Zb = new TH1D("h_phi_Zb", "h_phi_Zb", 40, -10., 10.); 
   ...
   h_eta_b_jet_2 = new TH1D("h_eta_b_jet_2", "h_eta_b_jet_2", 64, -8., 8.);
   h_eta_b_jet_2->GetXaxis()->SetTitle("#eta");
   h_eta_b_jet_2->GetYaxis()->SetTitle("Number of Events");
   
   h_phi_b_jet_1 = new TH1D("h_phi_b_jet_1", "h_phi_b_jet_1", 40, -10., 10.);
   h_phi_b_jet_1->GetXaxis()->SetTitle("#phi");
   h_phi_b_jet_1->GetYaxis()->SetTitle("Number of Events");
   
   h_phi_b_jet_2 = new TH1D("h_phi_b_jet_2", "h_phi_b_jet_2", 40, -10., 10.);
   ...
   h_eta_h1_ZaZb = new TH1D("h_eta_h1_ZaZb", "h_eta_h1_ZaZb", 100, -8., 8.);
   h_eta_h1_ZaZb->GetXaxis()->SetTitle("#eta");
   h_eta_h1_ZaZb->GetYaxis()->SetTitle("Number of Events");
      
   h_phi_h1_ZaZb = new TH1D("h_phi_h1_ZaZb", "h_phi_h1_ZaZb", 40, -10., 10.);
   ...
   h_eta_h1_b1b2 = new TH1D("h_eta_h1_b1b2", "h_eta_h1_b1b2", 64, -8., 8.);
   h_eta_h1_b1b2->GetXaxis()->SetTitle("#eta");
   h_eta_h1_b1b2->GetYaxis()->SetTitle("Number of Events"); 
      
   h_phi_h1_b1b2 = new TH1D("h_phi_h1_b1b2", "h_phi_h1_b1b2", 40, -10., 10.);
   ...
   h_eta_h2_h1h1 = new TH1D("h_eta_h2_h1h1", "h_eta_h2_h1h1", 64, -8., 8.);
   h_eta_h2_h1h1->GetXaxis()->SetTitle("#eta");
   h_eta_h2_h1h1->GetYaxis()->SetTitle("Number of Events");
   
   h_phi_h2_h1h1 = new TH1D("h_phi_h2_h1h1", "h_phi_h2_h1h1", 40, -8., 8.);
   ...
   TFile *indata = new TFile("/home/aya/programs/Delphes-3.4.2/zwpbbmv_decayMadspin_test.root", "READ");
   ...
   //TFile *op_file = new TFile("/media/aya/LinuxSpace/Pheno_Work_2/analysis/BackGrounds/output_demo_DY_20210920.root", "RECREATE"); 
   
   // ttbar
   //TFile *op_file = new TFile("/HEP_DATA/aya/Results/output_demo_ttbar.root", "RECREATE");
   //TFile *op_file = new TFile("/media/aya/LinuxSpace/Pheno_Work_2/analysis/BackGrounds/output_demo_ttbar_20210920.root", "RECREATE");
   ...
   TFile *op_file = new TFile("/home/aya/programs/Delphes-3.4.2/ouyput_demo_zwpbbmv_decayMadspin_test.root", "RECREATE"); // adding control region cuts
						...
						// if ( ( mh1_ZaZb < 115. ) || ( mh1_ZaZb > 135. ) ) continue;	
                            ...
                            for (Int_t i = 0; i < Jet_size; i++){
                               ...
                               /* Bool_t BtagOk = ( jet_bTag & (1 << 2) );    // for tight 
			                    ...
			                    if ( BtagOk == 1){  // jet assigned as loose WP b-jet
