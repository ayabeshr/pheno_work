...
void DemoAnalyzer::Loop()
{
 ...
 //TFile* sig        = new TFile("/media/aya/LinuxSpace/Pheno_Work_2/final_analysis/output_demo_Hhhbb4M_BMP1.root" , "RECREATE");
 ...
 /*TFile* DY         = new TFile("/media/aya/LinuxSpace/Pheno_Work_2/final_analysis/output_demo_DY.root"           , "RECREATE");
   ...
   //---------------------START TBranches DEFINITION--------------------
   
 /*b_Gen_Muon           = sig_tree->Branch("Gen_Muons"           ,   &genMuons  );
   b_Gen_Bjets          = sig_tree->Branch("Gen_BJets"           ,   &gen_bjet  );
   b_LooseMuons         = sig_tree->Branch("LooseMuons"          ,   &loose_mu  );
   b_Jets               = sig_tree->Branch("Jets"                ,   &jets      );
   b_MET                = sig_tree->Branch("MET"                 ,   &met       );
   b_deltaR_muons       = sig_tree->Branch("DeltaR_Muons"        ,   &drMuons   );
   b_Zmass_comb         = sig_tree->Branch("Zmass_Combinations"  ,   &zmass     );
   b_Za_signal          = sig_tree->Branch("ZaOFSignal"          ,   &za_sig    );
   b_Zb_signal          = sig_tree->Branch("ZbOFSignal"          ,   &zb_sig    );
   b_b1_signal          = sig_tree->Branch("bjet_1_OFSignal"     ,   &b1_sig    );
   b_b2_signal          = sig_tree->Branch("bjet_2_OFSignal"     ,   &b2_sig    );
   b_1st_Higgs_Ofsignal = sig_tree->Branch("1st_Higgs_OFSignal"  ,   &smhiggs1  );
   b_2nd_Higgs_Ofsignal = sig_tree->Branch("2nd_Higgs_OFSignal"  ,   &smhiggs2  );
   b_BSM_Higgs_Ofsignal = sig_tree->Branch("Heavy_Higgs_OFSignal",   &heavyHiggs); */
   
 /*b_Gen_Muon           = ttbar_tree->Branch("Gen_Muons"           ,   &genMuons  );
   b_Gen_Bjets          = ttbar_tree->Branch("Gen_BJets"           ,   &gen_bjet  );
   b_LooseMuons         = ttbar_tree->Branch("LooseMuons"          ,   &loose_mu  );
   b_Jets               = ttbar_tree->Branch("Jets"                ,   &jets      );
   b_MET                = ttbar_tree->Branch("MET"                 ,   &met       );
   b_deltaR_muons       = ttbar_tree->Branch("DeltaR_Muons"        ,   &drMuons   );
   b_Zmass_comb         = ttbar_tree->Branch("Zmass_Combinations"  ,   &zmass     );
   b_Za_signal          = ttbar_tree->Branch("ZaOFSignal"          ,   &za_sig    );
   b_Zb_signal          = ttbar_tree->Branch("ZbOFSignal"          ,   &zb_sig    );
   b_b1_signal          = ttbar_tree->Branch("bjet_1_OFSignal"     ,   &b1_sig    );
   b_b2_signal          = ttbar_tree->Branch("bjet_2_OFSignal"     ,   &b2_sig    );
   b_1st_Higgs_Ofsignal = ttbar_tree->Branch("1st_Higgs_OFSignal"  ,   &smhiggs1  );
   b_2nd_Higgs_Ofsignal = ttbar_tree->Branch("2nd_Higgs_OFSignal"  ,   &smhiggs2  );
   b_BSM_Higgs_Ofsignal = ttbar_tree->Branch("Heavy_Higgs_OFSignal",   &heavyHiggs); */
   
   b_Gen_Muon           = ZZ4Mu_tree->Branch("Gen_Muons"           ,   &genMuons  );
   b_Gen_Bjets          = ZZ4Mu_tree->Branch("Gen_BJets"           ,   &gen_bjet  );
   b_LooseMuons         = ZZ4Mu_tree->Branch("LooseMuons"          ,   &loose_mu  );
   b_Jets               = ZZ4Mu_tree->Branch("Jets"                ,   &jets      );
   b_MET                = ZZ4Mu_tree->Branch("MET"                 ,   &met       );
   b_4Muons             = ZZ4Mu_tree->Branch("Four_Muons"          ,   &four_muons);
   b_deltaR_muons       = ZZ4Mu_tree->Branch("DeltaR_Muons"        ,   &drMuons   );
   b_Zmass_comb         = ZZ4Mu_tree->Branch("Zmass_Combinations"  ,   &zmass     );
   b_Za_signal          = ZZ4Mu_tree->Branch("ZaOFSignal"          ,   &za_sig    );
   b_Zb_signal          = ZZ4Mu_tree->Branch("ZbOFSignal"          ,   &zb_sig    );
   b_b1_signal          = ZZ4Mu_tree->Branch("bjet_1_OFSignal"     ,   &b1_sig    );
   b_b2_signal          = ZZ4Mu_tree->Branch("bjet_2_OFSignal"     ,   &b2_sig    );
   b_1st_Higgs_Ofsignal = ZZ4Mu_tree->Branch("1st_Higgs_OFSignal"  ,   &smhiggs1  );
   b_2nd_Higgs_Ofsignal = ZZ4Mu_tree->Branch("2nd_Higgs_OFSignal"  ,   &smhiggs2  );
   b_BSM_Higgs_Ofsignal = ZZ4Mu_tree->Branch("Heavy_Higgs_OFSignal",   &heavyHiggs); 
   
 /*b_Gen_Muon           = DY_tree->Branch("Gen_Muons"           ,   &genMuons  );
   b_Gen_Bjets          = DY_tree->Branch("Gen_BJets"           ,   &gen_bjet  );
   b_LooseMuons         = DY_tree->Branch("LooseMuons"          ,   &loose_mu  );
   b_Jets               = DY_tree->Branch("Jets"                ,   &jets      );
   b_MET                = DY_tree->Branch("MET"                 ,   &met       );
   b_deltaR_muons       = DY_tree->Branch("DeltaR_Muons"        ,   &drMuons   );
   b_Zmass_comb         = DY_tree->Branch("Zmass_Combinations"  ,   &zmass     );
   b_Za_signal          = DY_tree->Branch("ZaOFSignal"          ,   &za_sig    );
   b_Zb_signal          = DY_tree->Branch("ZbOFSignal"          ,   &zb_sig    );
   b_b1_signal          = DY_tree->Branch("bjet_1_OFSignal"     ,   &b1_sig    );
   b_b2_signal          = DY_tree->Branch("bjet_2_OFSignal"     ,   &b2_sig    );
   b_1st_Higgs_Ofsignal = DY_tree->Branch("1st_Higgs_OFSignal"  ,   &smhiggs1  );
   b_2nd_Higgs_Ofsignal = DY_tree->Branch("2nd_Higgs_OFSignal"  ,   &smhiggs2  );
   b_BSM_Higgs_Ofsignal = DY_tree->Branch("Heavy_Higgs_OFSignal",   &heavyHiggs);  */
   
 /*b_Gen_Muon           = ZZbb2Mu_tree->Branch("Gen_Muons"           ,   &genMuons  );
   b_Gen_Bjets          = ZZbb2Mu_tree->Branch("Gen_BJets"           ,   &gen_bjet  );
   b_LooseMuons         = ZZbb2Mu_tree->Branch("LooseMuons"          ,   &loose_mu  );
   b_Jets               = ZZbb2Mu_tree->Branch("Jets"                ,   &jets      );
   b_MET                = ZZbb2Mu_tree->Branch("MET"                 ,   &met       );
   b_deltaR_muons       = ZZbb2Mu_tree->Branch("DeltaR_Muons"        ,   &drMuons   );
   b_Zmass_comb         = ZZbb2Mu_tree->Branch("Zmass_Combinations"  ,   &zmass     );
   b_Za_signal          = ZZbb2Mu_tree->Branch("ZaOFSignal"          ,   &za_sig    );
   b_Zb_signal          = ZZbb2Mu_tree->Branch("ZbOFSignal"          ,   &zb_sig    );
   b_b1_signal          = ZZbb2Mu_tree->Branch("bjet_1_OFSignal"     ,   &b1_sig    );
   b_b2_signal          = ZZbb2Mu_tree->Branch("bjet_2_OFSignal"     ,   &b2_sig    );
   b_1st_Higgs_Ofsignal = ZZbb2Mu_tree->Branch("1st_Higgs_OFSignal"  ,   &smhiggs1  );
   b_2nd_Higgs_Ofsignal = ZZbb2Mu_tree->Branch("2nd_Higgs_OFSignal"  ,   &smhiggs2  );
   b_BSM_Higgs_Ofsignal = ZZbb2Mu_tree->Branch("Heavy_Higgs_OFSignal",   &heavyHiggs);  */
   
/* b_Gen_Muon           = ZZ4b_tree->Branch("Gen_Muons"           ,   &genMuons  );
   b_Gen_Bjets          = ZZ4b_tree->Branch("Gen_BJets"           ,   &gen_bjet  );
   b_LooseMuons         = ZZ4b_tree->Branch("LooseMuons"          ,   &loose_mu  );
   b_Jets               = ZZ4b_tree->Branch("Jets"                ,   &jets      );
   b_MET                = ZZ4b_tree->Branch("MET"                 ,   &met       );
   b_deltaR_muons       = ZZ4b_tree->Branch("DeltaR_Muons"        ,   &drMuons   );
   b_Zmass_comb         = ZZ4b_tree->Branch("Zmass_Combinations"  ,   &zmass     );
   b_Za_signal          = ZZ4b_tree->Branch("ZaOFSignal"          ,   &za_sig    );
   b_Zb_signal          = ZZ4b_tree->Branch("ZbOFSignal"          ,   &zb_sig    );
   b_b1_signal          = ZZ4b_tree->Branch("bjet_1_OFSignal"     ,   &b1_sig    );
   b_b2_signal          = ZZ4b_tree->Branch("bjet_2_OFSignal"     ,   &b2_sig    );
   b_1st_Higgs_Ofsignal = ZZ4b_tree->Branch("1st_Higgs_OFSignal"  ,   &smhiggs1  );
   b_2nd_Higgs_Ofsignal = ZZ4b_tree->Branch("2nd_Higgs_OFSignal"  ,   &smhiggs2  );
   b_BSM_Higgs_Ofsignal = ZZ4b_tree->Branch("Heavy_Higgs_OFSignal",   &heavyHiggs); */
   
  /* b_Gen_Muon           = ZWpbbMuNL_tree->Branch("Gen_Muons"           ,   &genMuons  );
   b_Gen_Bjets          = ZWpbbMuNL_tree->Branch("Gen_BJets"           ,   &gen_bjet  );
   b_LooseMuons         = ZWpbbMuNL_tree->Branch("LooseMuons"          ,   &loose_mu  );
   b_Jets               = ZWpbbMuNL_tree->Branch("Jets"                ,   &jets      );
   b_MET                = ZWpbbMuNL_tree->Branch("MET"                 ,   &met       );
   b_deltaR_muons       = ZWpbbMuNL_tree->Branch("DeltaR_Muons"        ,   &drMuons   );
   b_Zmass_comb         = ZWpbbMuNL_tree->Branch("Zmass_Combinations"  ,   &zmass     );
   b_Za_signal          = ZWpbbMuNL_tree->Branch("ZaOFSignal"          ,   &za_sig    );
   b_Zb_signal          = ZWpbbMuNL_tree->Branch("ZbOFSignal"          ,   &zb_sig    );
   b_b1_signal          = ZWpbbMuNL_tree->Branch("bjet_1_OFSignal"     ,   &b1_sig    );
   b_b2_signal          = ZWpbbMuNL_tree->Branch("bjet_2_OFSignal"     ,   &b2_sig    );
   b_1st_Higgs_Ofsignal = ZWpbbMuNL_tree->Branch("1st_Higgs_OFSignal"  ,   &smhiggs1  );
   b_2nd_Higgs_Ofsignal = ZWpbbMuNL_tree->Branch("2nd_Higgs_OFSignal"  ,   &smhiggs2  );
   b_BSM_Higgs_Ofsignal = ZWpbbMuNL_tree->Branch("Heavy_Higgs_OFSignal",   &heavyHiggs); */
   
  /* b_Gen_Muon           = ZWp2MuMuNL_tree->Branch("Gen_Muons"           ,   &genMuons  );
   b_Gen_Bjets          = ZWp2MuMuNL_tree->Branch("Gen_BJets"           ,   &gen_bjet  );
   b_LooseMuons         = ZWp2MuMuNL_tree->Branch("LooseMuons"          ,   &loose_mu  );
   b_Jets               = ZWp2MuMuNL_tree->Branch("Jets"                ,   &jets      );
   b_MET                = ZWp2MuMuNL_tree->Branch("MET"                 ,   &met       );
   b_deltaR_muons       = ZWp2MuMuNL_tree->Branch("DeltaR_Muons"        ,   &drMuons   );
   b_Zmass_comb         = ZWp2MuMuNL_tree->Branch("Zmass_Combinations"  ,   &zmass     );
   b_Za_signal          = ZWp2MuMuNL_tree->Branch("ZaOFSignal"          ,   &za_sig    );
   b_Zb_signal          = ZWp2MuMuNL_tree->Branch("ZbOFSignal"          ,   &zb_sig    );
   b_b1_signal          = ZWp2MuMuNL_tree->Branch("bjet_1_OFSignal"     ,   &b1_sig    );
   b_b2_signal          = ZWp2MuMuNL_tree->Branch("bjet_2_OFSignal"     ,   &b2_sig    );
   b_1st_Higgs_Ofsignal = ZWp2MuMuNL_tree->Branch("1st_Higgs_OFSignal"  ,   &smhiggs1  );
   b_2nd_Higgs_Ofsignal = ZWp2MuMuNL_tree->Branch("2nd_Higgs_OFSignal"  ,   &smhiggs2  );
   b_BSM_Higgs_Ofsignal = ZWp2MuMuNL_tree->Branch("Heavy_Higgs_OFSignal",   &heavyHiggs); */
   
  /* b_Gen_Muon           = ZWmbbMuNL_tree->Branch("Gen_Muons"           ,   &genMuons  );
   b_Gen_Bjets          = ZWmbbMuNL_tree->Branch("Gen_BJets"           ,   &gen_bjet  );
   b_LooseMuons         = ZWmbbMuNL_tree->Branch("LooseMuons"          ,   &loose_mu  );
   b_Jets               = ZWmbbMuNL_tree->Branch("Jets"                ,   &jets      );
   b_MET                = ZWmbbMuNL_tree->Branch("MET"                 ,   &met       );
   b_deltaR_muons       = ZWmbbMuNL_tree->Branch("DeltaR_Muons"        ,   &drMuons   );
   b_Zmass_comb         = ZWmbbMuNL_tree->Branch("Zmass_Combinations"  ,   &zmass     );
   b_Za_signal          = ZWmbbMuNL_tree->Branch("ZaOFSignal"          ,   &za_sig    );
   b_Zb_signal          = ZWmbbMuNL_tree->Branch("ZbOFSignal"          ,   &zb_sig    );
   b_b1_signal          = ZWmbbMuNL_tree->Branch("bjet_1_OFSignal"     ,   &b1_sig    );
   b_b2_signal          = ZWmbbMuNL_tree->Branch("bjet_2_OFSignal"     ,   &b2_sig    );
   b_1st_Higgs_Ofsignal = ZWmbbMuNL_tree->Branch("1st_Higgs_OFSignal"  ,   &smhiggs1  );
   b_2nd_Higgs_Ofsignal = ZWmbbMuNL_tree->Branch("2nd_Higgs_OFSignal"  ,   &smhiggs2  );
   b_BSM_Higgs_Ofsignal = ZWmbbMuNL_tree->Branch("Heavy_Higgs_OFSignal",   &heavyHiggs);  */
   
 /*  b_Gen_Muon           = ZWm2MuMuNL_tree->Branch("Gen_Muons"           ,   &genMuons  );
   b_Gen_Bjets          = ZWm2MuMuNL_tree->Branch("Gen_BJets"           ,   &gen_bjet  );
   b_LooseMuons         = ZWm2MuMuNL_tree->Branch("LooseMuons"          ,   &loose_mu  );
   b_Jets               = ZWm2MuMuNL_tree->Branch("Jets"                ,   &jets      );
   b_MET                = ZWm2MuMuNL_tree->Branch("MET"                 ,   &met       );
   b_deltaR_muons       = ZWm2MuMuNL_tree->Branch("DeltaR_Muons"        ,   &drMuons   );
   b_Zmass_comb         = ZWm2MuMuNL_tree->Branch("Zmass_Combinations"  ,   &zmass     );
   b_Za_signal          = ZWm2MuMuNL_tree->Branch("ZaOFSignal"          ,   &za_sig    );
   b_Zb_signal          = ZWm2MuMuNL_tree->Branch("ZbOFSignal"          ,   &zb_sig    );
   b_b1_signal          = ZWm2MuMuNL_tree->Branch("bjet_1_OFSignal"     ,   &b1_sig    );
   b_b2_signal          = ZWm2MuMuNL_tree->Branch("bjet_2_OFSignal"     ,   &b2_sig    );
   b_1st_Higgs_Ofsignal = ZWm2MuMuNL_tree->Branch("1st_Higgs_OFSignal"  ,   &smhiggs1  );
   b_2nd_Higgs_Ofsignal = ZWm2MuMuNL_tree->Branch("2nd_Higgs_OFSignal"  ,   &smhiggs2  );
   b_BSM_Higgs_Ofsignal = ZWm2MuMuNL_tree->Branch("Heavy_Higgs_OFSignal",   &heavyHiggs);  */
   
  /* b_Gen_Muon           = WW2Mu2NL_tree->Branch("Gen_Muons"           ,   &genMuons  );
   b_Gen_Bjets          = WW2Mu2NL_tree->Branch("Gen_BJets"           ,   &gen_bjet  );
   b_LooseMuons         = WW2Mu2NL_tree->Branch("LooseMuons"          ,   &loose_mu  );
   b_Jets               = WW2Mu2NL_tree->Branch("Jets"                ,   &jets      );
   b_MET                = WW2Mu2NL_tree->Branch("MET"                 ,   &met       );
   b_deltaR_muons       = WW2Mu2NL_tree->Branch("DeltaR_Muons"        ,   &drMuons   );
   b_Zmass_comb         = WW2Mu2NL_tree->Branch("Zmass_Combinations"  ,   &zmass     );
   b_Za_signal          = WW2Mu2NL_tree->Branch("ZaOFSignal"          ,   &za_sig    );
   b_Zb_signal          = WW2Mu2NL_tree->Branch("ZbOFSignal"          ,   &zb_sig    );
   b_b1_signal          = WW2Mu2NL_tree->Branch("bjet_1_OFSignal"     ,   &b1_sig    );
   b_b2_signal          = WW2Mu2NL_tree->Branch("bjet_2_OFSignal"     ,   &b2_sig    );
   b_1st_Higgs_Ofsignal = WW2Mu2NL_tree->Branch("1st_Higgs_OFSignal"  ,   &smhiggs1  );
   b_2nd_Higgs_Ofsignal = WW2Mu2NL_tree->Branch("2nd_Higgs_OFSignal"  ,   &smhiggs2  );
   b_BSM_Higgs_Ofsignal = WW2Mu2NL_tree->Branch("Heavy_Higgs_OFSignal",   &heavyHiggs);  */
   
  /* b_Gen_Muon           = smHZZ4Mu_tree->Branch("Gen_Muons"           ,   &genMuons  );
   b_Gen_Bjets          = smHZZ4Mu_tree->Branch("Gen_BJets"           ,   &gen_bjet  );
   b_LooseMuons         = smHZZ4Mu_tree->Branch("LooseMuons"          ,   &loose_mu  );
   b_Jets               = smHZZ4Mu_tree->Branch("Jets"                ,   &jets      );
   b_MET                = smHZZ4Mu_tree->Branch("MET"                 ,   &met       );
   b_deltaR_muons       = smHZZ4Mu_tree->Branch("DeltaR_Muons"        ,   &drMuons   );
   b_Zmass_comb         = smHZZ4Mu_tree->Branch("Zmass_Combinations"  ,   &zmass     );
   b_Za_signal          = smHZZ4Mu_tree->Branch("ZaOFSignal"          ,   &za_sig    );
   b_Zb_signal          = smHZZ4Mu_tree->Branch("ZbOFSignal"          ,   &zb_sig    );
   b_b1_signal          = smHZZ4Mu_tree->Branch("bjet_1_OFSignal"     ,   &b1_sig    );
   b_b2_signal          = smHZZ4Mu_tree->Branch("bjet_2_OFSignal"     ,   &b2_sig    );
   b_1st_Higgs_Ofsignal = smHZZ4Mu_tree->Branch("1st_Higgs_OFSignal"  ,   &smhiggs1  );
   b_2nd_Higgs_Ofsignal = smHZZ4Mu_tree->Branch("2nd_Higgs_OFSignal"  ,   &smhiggs2  );
   b_BSM_Higgs_Ofsignal = smHZZ4Mu_tree->Branch("Heavy_Higgs_OFSignal",   &heavyHiggs);  */
   
 /*  b_Gen_Muon           = smHbb_tree->Branch("Gen_Muons"           ,   &genMuons  );
   b_Gen_Bjets          = smHbb_tree->Branch("Gen_BJets"           ,   &gen_bjet  );
   b_LooseMuons         = smHbb_tree->Branch("LooseMuons"          ,   &loose_mu  );
   b_Jets               = smHbb_tree->Branch("Jets"                ,   &jets      );
   b_MET                = smHbb_tree->Branch("MET"                 ,   &met       );
   b_deltaR_muons       = smHbb_tree->Branch("DeltaR_Muons"        ,   &drMuons   );
   b_Zmass_comb         = smHbb_tree->Branch("Zmass_Combinations"  ,   &zmass     );
   b_Za_signal          = smHbb_tree->Branch("ZaOFSignal"          ,   &za_sig    );
   b_Zb_signal          = smHbb_tree->Branch("ZbOFSignal"          ,   &zb_sig    );
   b_b1_signal          = smHbb_tree->Branch("bjet_1_OFSignal"     ,   &b1_sig    );
   b_b2_signal          = smHbb_tree->Branch("bjet_2_OFSignal"     ,   &b2_sig    );
   b_1st_Higgs_Ofsignal = smHbb_tree->Branch("1st_Higgs_OFSignal"  ,   &smhiggs1  );
   b_2nd_Higgs_Ofsignal = smHbb_tree->Branch("2nd_Higgs_OFSignal"  ,   &smhiggs2  );
   b_BSM_Higgs_Ofsignal = smHbb_tree->Branch("Heavy_Higgs_OFSignal",   &heavyHiggs); */
  ...
  //  ttbar_tree->SetWeight(wt);
   ...
   /* DY_tree->SetWeight(wt); 
    ...
    ZWp2MuMuNL_tree->SetWeight(wt); 
    ZWmbbMuNL_tree->SetWeight(wt);  
    ZWm2MuMuNL_tree->SetWeight(wt); 
    WW2Mu2NL_tree ->SetWeight(wt); 
    smHZZ4Mu_tree->SetWeight(wt);  
    smHbb_tree->SetWeight(wt); */   
   ...
   /* DY_tree->Fill(); 
    ...
    ZZ4b_tree->Fill();       
    ZWpbbMuNL_tree->Fill(); 
    ZWp2MuMuNL_tree->Fill(); 
    ZWmbbMuNL_tree->Fill();  
    ZWm2MuMuNL_tree->Fill(); 
    WW2Mu2NL_tree ->Fill(); 
    smHZZ4Mu_tree->Fill();  
    smHbb_tree->Fill();  */ 
  ...
  */    
   ...
   /* DY_tree->Write(); 
    ZZbb2Mu_tree->Write();  
    ZZ4b_tree->Write();       
    ZWpbbMuNL_tree->Write(); 
    ZWp2MuMuNL_tree->Write(); 
    ZWmbbMuNL_tree->Write();  
    ZWm2MuMuNL_tree->Write(); 
    WW2Mu2NL_tree->Write(); 
    smHZZ4Mu_tree->Write();  
    smHbb_tree->Write();  */
