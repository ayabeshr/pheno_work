...
void DemoAnalyzer::Loop()
{
   ...
   //TFile *in_sig = new TFile("/home/aya/programs/Delphes-3.4.2/sig_1e04Events.root", "READ");
   ...
   float org_xsec = 1.2416e-04;    //original xsec in pb
   float org_xsc_fb = org_xsec * 1.e+03;
   float sf_xsec = org_xsec * scale_factor;
   float sf_xsc_fb = sf_xsec * 1.e+03;   // scaled xsec in fb 
 ...
 TH1F *cut1 = new TH1F("muon loose  p_{T}", "muon loose p_{T}",250,0,500);
 TH1F *cut2 = new TH1F("muon loose eta", "muon loose eta",20,-10,10);
 TH1F *cut3 = new TH1F("leading muon p_{T}", "leading muon p_{T}",250,0,500);
 TH1F *cut4 = new TH1F("subleading muon p_{T}", "subleading muon p_{T}",150,0,300);
 TH1F *cut5 = new TH1F("DeltaR mu12", "DeltaR mu12", 20,0,20);
 TH1F *cut6 = new TH1F("DeltaR mu34", "DeltaR mu34", 20,0,20);
 TH1F *cut7 = new TH1F("DeltaR mu13", "DeltaR mu13", 20,0,20);
 TH1F *cut8 = new TH1F("DeltaR mu24", "DeltaR mu24", 20,0,20);
 TH1F *cut9 = new TH1F("DeltaR mu14", "DeltaR mu14", 20,0,20);
 TH1F *cut10 = new TH1F("DeltaR mu23", "DeltaR mu23", 20,0,20);
 TH1F *cut11 = new TH1F("mass of muon pair 12", "mass of muon pair 12",250,0,500);
 TH1F *cut12 = new TH1F("mass of muon pair 34", "mass of muon pair 34",250,0,500);
 TH1F *cut13 = new TH1F("mass of muon pair 13", "mass of muon pair 13",250,0,500);
 TH1F *cut14 = new TH1F("mass of muon pair 24", "mass of muon pair 24",250,0,500);
 TH1F *cut15 = new TH1F("mass of muon pair 14", "mass of muon pair 14",250,0,500);
 TH1F *cut16 = new TH1F("mass of muon pair 23", "mass of muon pair 23",250,0,500 );
 TH1F *cut17 = new TH1F("Za mass", "Za mass",60,60,140);
 TH1F *cut18 = new TH1F("Zb mass", "Zb mass",60,60,140);
 TH1F *cut19 = new TH1F("DeltaR_b_mu1", "DeltaR_b_mu1",20,0,20);
 TH1F *cut20 = new TH1F("DeltaR_b_mu2", "DeltaR_b_mu2",20,0,20);
 TH1F *cut21 = new TH1F("DeltaR_b_mu3", "DeltaR_b_mu3",20,0,20);
 TH1F *cut22 = new TH1F("DeltaR_b_mu4", "DeltaR_b_mu4",20,0,20);
 TH1F *cut23 = new TH1F("loose b-jet p_{T}", "loose b-jet p_{T}",250,0,500);
 TH1F *cut24 = new TH1F("loose b-jet eta", "loose b-jet eta",20,-10,10);
 TH1F *cut25 = new TH1F("1st loose b-jet p_{T}", "1st loose b-jet p_{T}",250,0,500);
 TH1F *cut26 = new TH1F("1st loose b-jet eta", "1st loose b-jet eta",20,-10,10);
 TH1F *cut27 = new TH1F("2nd loose b-jet p_{T}", "2nd loose b-jet p_{T}",250,0,500);
 TH1F *cut28 = new TH1F("2nd loose b-jet eta", "2nd loose b-jet eta",20,-10,10);


cut1->GetXaxis()->SetTitle("p_{T} [GeV/C]");
cut1->GetYaxis()->SetTitle("Events");

cut2->GetXaxis()->SetTitle("#eta");
cut2->GetYaxis()->SetTitle("Events");

cut3->GetXaxis()->SetTitle("p_{T} [GeV/C]");
cut3->GetYaxis()->SetTitle("Events");

cut4->GetXaxis()->SetTitle("p_{T} [GeV/C]");
cut4->GetYaxis()->SetTitle("Events");

cut5->GetXaxis()->SetTitle("#Delta R_{mu12}");
cut5->GetYaxis()->SetTitle("Events");

cut6->GetXaxis()->SetTitle("#Delta R_{mu34}");
cut6->GetYaxis()->SetTitle("Events");

cut7->GetXaxis()->SetTitle("#Delta R_{mu13}");
cut7->GetYaxis()->SetTitle("Events");

cut8->GetXaxis()->SetTitle("#Delta R_{mu24}");
cut8->GetYaxis()->SetTitle("Events");

cut9->GetXaxis()->SetTitle("#Delta R_{mu14}");
cut9->GetYaxis()->SetTitle("Events");

cut10->GetXaxis()->SetTitle("#Delta R_{mu23}");
cut10->GetYaxis()->SetTitle("Events");

cut11->GetXaxis()->SetTitle("mass_{mu12} [GeV]");
cut11->GetYaxis()->SetTitle("Events");

cut12->GetXaxis()->SetTitle("mass_{mu34} [GeV]");
cut12->GetYaxis()->SetTitle("Events");

cut13->GetXaxis()->SetTitle("mass_{mu13} [GeV]");
cut13->GetYaxis()->SetTitle("Events");

cut14->GetXaxis()->SetTitle("mass_{mu24} [GeV]");
cut14->GetYaxis()->SetTitle("Events");

cut15->GetXaxis()->SetTitle("mass_{mu14} [GeV]");
cut15->GetYaxis()->SetTitle("Events");

cut16->GetXaxis()->SetTitle("mass_{mu23} [GeV]");
cut16->GetYaxis()->SetTitle("Events");

cut17->GetXaxis()->SetTitle("Za mass [GeV]");
cut17->GetYaxis()->SetTitle("Events");

cut18->GetXaxis()->SetTitle("Zb mass [GeV]");
cut18->GetYaxis()->SetTitle("Events");

cut19->GetXaxis()->SetTitle("#Delta R_{(b,mu1)}");
cut19->GetYaxis()->SetTitle("Events");

cut20->GetXaxis()->SetTitle("#Delta R_{(b,mu2)}");
cut20->GetYaxis()->SetTitle("Events");

cut21->GetXaxis()->SetTitle("#Delta R_{(b,mu3)}");
cut21->GetYaxis()->SetTitle("Events");

cut22->GetXaxis()->SetTitle("#Delta R_{(b,mu4)}");
cut22->GetYaxis()->SetTitle("Events");

cut23->GetXaxis()->SetTitle("p_{T} [GeV/C]");
cut23->GetYaxis()->SetTitle("Events");

cut24->GetXaxis()->SetTitle("|\eta|");
cut24->GetYaxis()->SetTitle("Events");

cut25->GetXaxis()->SetTitle("p_{T} [GeV/C]");
cut25->GetYaxis()->SetTitle("Events");

cut26->GetXaxis()->SetTitle("|\eta|");
cut26->GetYaxis()->SetTitle("Events");

cut27->GetXaxis()->SetTitle("p_{T} [GeV/C]");
cut27->GetYaxis()->SetTitle("Events");

cut28->GetXaxis()->SetTitle("|\eta|");
cut28->GetYaxis()->SetTitle("Events");
  ...
  /*==================================================================================*/ 
   ...
   for (Long64_t jentry = 0; jentry < nentries; jentry++)  
   {
	...
	met.met_phi.push_back(MET_phi);
	  ...
	  float muonL_abseta = fabs(MuonLoose_Eta[i]);
	  float muonL_eta = MuonLoose_Eta[i];

	  cut1->Fill(muonL_pt, wt);
	  cut2->Fill(muonL_eta, wt);
	 ...
	 four_muons_beforeCut.muon1_pt.push_back(pt_mu1);
         ...
         cut5->Fill(DR_mu12, wt);
	 cut6->Fill(DR_mu34, wt);
         cut7->Fill(DR_mu13, wt);
	 cut8->Fill(DR_mu24, wt);
	 cut9->Fill(DR_mu14, wt);
	 cut10->Fill(DR_mu23, wt);
			  ...
			  */
			  ...
			  // bool found_bjet = false;
				...
				for ( Int_t i = 0; i < bjet_indx.size(); i++ ) { 
				    ...
				    if ( i = 0){ // 1st b-jet in vector (highest pt)

				      cut25->Fill(bjet_pt, wt);
                                      cut26->Fill(bjet_eta, wt);
				      
				    }

				    if ( i = 1){ // 2nd b-jet in vector (2nd highest pt)

				      cut27->Fill(bjet_pt, wt);
                                      cut28->Fill(bjet_eta, wt);
				    ...
				    cut19->Fill(DR_b_mu1, wt);
                                    cut20->Fill(DR_b_mu2, wt);
                                    cut21->Fill(DR_b_mu3, wt);
                                    cut22->Fill(DR_b_mu4, wt);
				    cut23->Fill(bjet_pt, wt);    // pT for all b-jets/event before applying any cuts
				    cut24->Fill(bjet_eta, wt);
