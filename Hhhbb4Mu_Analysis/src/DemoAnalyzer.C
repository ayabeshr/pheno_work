...
void DemoAnalyzer::Loop()
{
   ...
   // TFile *in_ZHTobb4Mu = new TFile("/media/aya/PACKUP/Aya/final_analysis/inputs/ZHTobb4Mu_LO_20220422.root" , "READ");
   // TFile *in_TTZTobb4Mu = new TFile("/media/aya/PACKUP/Aya/final_analysis/inputs/TTZTobb4Mu_LO_20220422.root" , "READ");
   // TFile *in_TTHTobb6Mu = new TFile("/media/aya/PACKUP/Aya/final_analysis/inputs/TTHTobb6Mu_LO_20220422.root" , "READ");
   ...
   // TFile *out_sig = new TFile("/home/aya/Pheno_Work/analysis/bkg_outputfiles_forSelections20220420/signal_mupT_20-10GeV_20220422.root", "RECREATE");
   //  TFile *out_sig = new TFile("/media/aya/PACKUP/Aya/final_analysis/outputs_20220422/ns_sig_mupT_20-10GeV_20220422.root", "RECREATE");
   //TFile *out_sig = new TFile("/home/aya/Pictures/finalSel_sig_mupT_20-10GeV_20220422.root", "RECREATE");//ns refers to new selection
   TFile *out_sig = new TFile("/home/aya/Pictures/finalSel_sig2_10to-5pb_mupT_20-10GeV_20220422.root", "RECREATE");//ns refers to new selection 									      	 
   ...
   // TFile *out_ZHTobb4Mu   = new TFile("/home/aya/Pheno_Work/analysis/bkg_outputfiles_forSelections20220420/ZHTobb4Mu_mupT_20-10GeV_20220422.root", "RECREATE");
   // TFile *out_ZHTobb4Mu   = new TFile("/media/aya/PACKUP/Aya/final_analysis/outputs_20220422/finalSel_ZHTobb4Mu_mupT_20-10GeV_20220422.root", "RECREATE");
   // TFile *out_TTZTobb4Mu   = new TFile("/media/aya/PACKUP/Aya/final_analysis/outputs_20220422/finalSel_TTZTobb4Mu_mupT_20-10GeV_20220422.root", "RECREATE");
   // TFile *out_TTHTobb6Mu   = new TFile("/media/aya/PACKUP/Aya/final_analysis/outputs_20220422/finalSel_TTHTobb6Mu_mupT_20-10GeV_20220422.root", "RECREATE");
   // TFile* out_ZZZbb4Mu = new TFile("/media/aya/PACKUP/Aya/final_analysis/outputs_20220422/finalSel_ZZZTobb4Mu_mupT_20-10GeV_20220422.root", "RECREATE");
   // TFile* out_ZZ4Mu = new TFile("/media/aya/PACKUP/Aya/final_analysis/outputs_20220422/finalSel_ZZ4Mu_mupT_20-10GeV_20220422.root", "RECREATE");
   // TFile *out_sm_HTobb = new TFile("/media/aya/PACKUP/Aya/final_analysis/outputs_20220422/finalSel_HTobb_mupT_20-10GeV_20220422.root", "RECREATE");
   //TFile *out_sm_H4Mu  = new TFile("/media/aya/PACKUP/Aya/final_analysis/outputs_20220422/finalSel_HTo4Mu_mupT_20-10GeV_20220422.root", "RECREATE");
   ...
   vector<Int_t> jet_id;                // saves tight b-jet index 
  ...
  /*==================================================================================*/ 
	 ...
	 /* if ( (dxy_mu1 < 0.12) && (dxy_mu2 < 0.12)
		...
		if ( ( MuonTight_Charge[mu1_idx] + MuonTight_Charge[mu4_idx] != 0) &&  
	     ...
	     if ( (mZ1 > 70.) && (mZ1 < 100.) ){
		   ...
		   if ( ( 90. < m_4Mu ) && ( m_4Mu < 130. ) ){   // selection on invariant mass of 4 muons
		     ...
		     zb_sig_m4Mu_cut.push_back(mZ2);
		        ...
		        int nLoose = 0;
                        int nMed   = 0;
			int nTight = 0;
		        int njets_first_sel = 0;             // total jets passed 1st selections pf pT, eta & DR
			UInt_t first_max_score = 0;
			UInt_t sec_max_score   = 0;
			int sec_max_id   = -1;
			int first_max_id = -1;
			
		      	Int_t id, tmp_id, tmp2_id, tmp3_id;
			    ...
			    double DEta_j_mu1_sqr = TMath::Power(( j_eta - lep1[1] ), 2);
		 	    double DEta_j_mu2_sqr = TMath::Power(( j_eta - lep2[1] ), 2);
		            double DEta_j_mu3_sqr = TMath::Power(( j_eta - lep3[1] ), 2);
			    double DEta_j_mu4_sqr = TMath::Power(( j_eta - lep4[1] ), 2);
			    double DPhi_j_mu1_sqr = TMath::Power(( j_phi - lep1[2]), 2);
			    double DPhi_j_mu2_sqr = TMath::Power(( j_phi - lep2[2]), 2);
		            double DPhi_j_mu3_sqr = TMath::Power(( j_phi - lep3[2]), 2);
		            double DPhi_j_mu4_sqr = TMath::Power(( j_phi - lep4[2]), 2);
					        			 
			    double DR_j_mu1 = TMath::Sqrt( DEta_j_mu1_sqr + DPhi_j_mu1_sqr );
		            double DR_j_mu2 = TMath::Sqrt( DEta_j_mu2_sqr + DPhi_j_mu2_sqr );
	       	            double DR_j_mu3 = TMath::Sqrt( DEta_j_mu3_sqr + DPhi_j_mu3_sqr );
			    double DR_j_mu4 = TMath::Sqrt( DEta_j_mu4_sqr + DPhi_j_mu4_sqr );

			    if ( (j_pt > 20.) && (abs(j_eta) < 2.7) ){

 			       // 12th Selection: on DR(bjet_loose, mu_tight)
 
			       if ( ( DR_j_mu1 > 0.4 ) && ( DR_j_mu2 > 0.4 )
				      && ( DR_j_mu3 > 0.4 ) && ( DR_j_mu4 > 0.4 ) ){

				  jet_id.push_back(tmp_id);     // saves jet id passes the selections
				  njets_first_sel++;
			...
			cout << "N Jets after first Selections on pT, eta, DR   "  << njets_first_sel << endl;


		      	if ( jet_id.size() > 1 ){  // have at least 2 jets/event

			  NEvents[18]++;

			  //=========================================
			  //       Investigate WP: L, M, T
			  //=========================================

			  for ( Int_t i = 0; i < jet_id.size(); i++){

                            id = jet_id[i];
			    UInt_t jet_BTag = Jet_BTag[id];
			  ...
			  cout << "N Loose  B-Jets  >>  " << nLoose << endl;
                          cout << "N Medium B-Jets  >>  " << nMed   << endl;
			  cout << "N Tight  B-Jets  >>  " << nTight << endl;

			  if ( nLoose > 1 ) NEvents[15]++;
			  if ( nMed > 1   ) NEvents[16]++;
                          if ( nTight > 1 ) NEvents[17]++;

			  
			  //===========================================
			  //  Select 2 Jets with Highest BTag Scores
			  //==========================================

			  for ( Int_t i = 0; i < jet_id.size(); i++){

                             cout << " we are in 1st loop" << endl;
			    
			     tmp2_id = jet_id[i];
			     UInt_t jet_btag = Jet_BTag[tmp2_id];
			     
                             if ( jet_btag > first_max_score ){    
				                                                            
                               found_1st = true;
			       first_max_score = jet_btag;
			       first_max_id = tmp2_id;

			       cout << "First Max BTag score   " << first_max_score << "  Jet ID  " << first_max_id << endl;
			  ...
			  for ( Int_t ii = 0; ii < jet_id.size(); ii++){
			    
                              cout << " we are in 2nd loop" << endl;
                              
			      tmp3_id = jet_id[ii];
			      UInt_t jet_btag2 = Jet_BTag[tmp3_id];

                              if ( tmp3_id == first_max_id ) continue;   // skip this loop iteration if we have the same 1st max score id

			      if ( jet_btag2 > sec_max_score ){
				
				found_2nd = true;
		          	sec_max_score = jet_btag2;
                                sec_max_id = tmp3_id;

			        cout << "Sec Max BTag score     " << sec_max_score   << "  Jet ID  " << sec_max_id << endl;

			      } // end if jet_btag2 != 0

                          } // end 2nd loop

			  if ( found_1st && found_2nd ){

                            cout << "Found 2 Jets with Highest BTag Scores!! \n" << endl;
			    cout << "============================" << endl;
			    cout << "Jet_ID        |  " << first_max_id << "  |  "  << sec_max_id << endl;
			    cout << "============================" << endl;
			    cout << "BTag score    |  " << first_max_score << "  |  " << sec_max_score << endl;
                            cout << "============================" << endl;
			  ...
			  b1.SetPtEtaPhiM( Jet_PT[first_max_id], Jet_Eta[first_max_id], Jet_Phi[first_max_id], Jet_Mass[first_max_id] );
			  cout << " 1st bjet LorentVector defined " << endl;
		  	  b2.SetPtEtaPhiM( Jet_PT[sec_max_id]  , Jet_Eta[sec_max_id]  , Jet_Phi[sec_max_id]  , Jet_Mass[sec_max_id] );
			  ...
			  if ( m_2bjets > 30. && m_2bjets < 180. ){
			    ...
			    NEvents[12]++;
			     ...
			     double DEta_b1_mu1_sqr = TMath::Power(( bj1_eta - lep1[1] ), 2);
		   	     double DEta_b1_mu2_sqr = TMath::Power(( bj1_eta - lep2[1] ), 2);
			     double DEta_b1_mu3_sqr = TMath::Power(( bj1_eta - lep3[1] ), 2);
			     double DEta_b1_mu4_sqr = TMath::Power(( bj1_eta - lep4[1] ), 2);
			     double DPhi_b1_mu1_sqr = TMath::Power(( bj1_phi - lep1[2]), 2);
		             double DPhi_b1_mu2_sqr = TMath::Power(( bj1_phi - lep2[2]), 2);
		 	     double DPhi_b1_mu3_sqr = TMath::Power(( bj1_phi - lep3[2]), 2);
		             double DPhi_b1_mu4_sqr = TMath::Power(( bj1_phi - lep4[2]), 2);
			     ...
			     double dR_b1_mu4 = TMath::Sqrt( DEta_b1_mu4_sqr + DPhi_b1_mu4_sqr );
		             ...
		             double DEta_b2_mu1_sqr = TMath::Power(( bj2_eta - lep1[1] ), 2);
		             double DEta_b2_mu2_sqr = TMath::Power(( bj2_eta - lep2[1] ), 2);
			     double DEta_b2_mu3_sqr = TMath::Power(( bj2_eta - lep3[1] ), 2);
			     double DEta_b2_mu4_sqr = TMath::Power(( bj2_eta - lep4[1] ), 2);
			     double DPhi_b2_mu1_sqr = TMath::Power(( bj2_phi - lep1[2]), 2);
			     double DPhi_b2_mu2_sqr = TMath::Power(( bj2_phi - lep2[2]), 2);
			     double DPhi_b2_mu3_sqr = TMath::Power(( bj2_phi - lep3[2]), 2);
			     double DPhi_b2_mu4_sqr = TMath::Power(( bj2_phi - lep4[2]), 2);
			     ...
			     // DR bet muons
                             ...
                             double DEta_sqr_LEP_12 = TMath::Power( (lep1[1] - lep2[1]) , 2);
                             double DEta_sqr_LEP_34 = TMath::Power( (lep3[1] - lep4[1]) , 2);
                             double DEta_sqr_LEP_13 = TMath::Power( (lep1[1] - lep3[1]) , 2);
                             double DEta_sqr_LEP_24 = TMath::Power( (lep2[1] - lep4[1]) , 2);
                             double DEta_sqr_LEP_14 = TMath::Power( (lep1[1] - lep4[1]) , 2);
                             double DEta_sqr_LEP_23 = TMath::Power( (lep2[1] - lep3[1]) , 2);
                         
                             double DPhi_sqr_LEP_12 = TMath::Power( (lep1[2] - lep2[2]) , 2);
                             double DPhi_sqr_LEP_34 = TMath::Power( (lep3[2] - lep4[2]) , 2);
                             double DPhi_sqr_LEP_13 = TMath::Power( (lep1[2] - lep3[2]) , 2);
                             double DPhi_sqr_LEP_24 = TMath::Power( (lep2[2] - lep4[2]) , 2);
                             double DPhi_sqr_LEP_14 = TMath::Power( (lep1[2] - lep4[2]) , 2);
                             double DPhi_sqr_LEP_23 = TMath::Power( (lep2[2] - lep3[2]) , 2);
                         
                             double DR_LEP_12 = TMath::Sqrt( DEta_sqr_LEP_12 + DPhi_sqr_LEP_12 );
                             double DR_LEP_34 = TMath::Sqrt( DEta_sqr_LEP_34 + DPhi_sqr_LEP_34 );
                             double DR_LEP_13 = TMath::Sqrt( DEta_sqr_LEP_13 + DPhi_sqr_LEP_13 );
                             double DR_LEP_24 = TMath::Sqrt( DEta_sqr_LEP_24 + DPhi_sqr_LEP_24 );
                             double DR_LEP_14 = TMath::Sqrt( DEta_sqr_LEP_14 + DPhi_sqr_LEP_14 );
                             double DR_LEP_23 = TMath::Sqrt( DEta_sqr_LEP_23 + DPhi_sqr_LEP_23 );
                         
                             drMuonsTight.DR_lep_12.push_back(DR_LEP_12);
                             drMuonsTight.DR_lep_34.push_back(DR_LEP_34);
                             drMuonsTight.DR_lep_13.push_back(DR_LEP_13);
                             drMuonsTight.DR_lep_24.push_back(DR_LEP_24);
                             drMuonsTight.DR_lep_14.push_back(DR_LEP_14);
                             drMuonsTight.DR_lep_23.push_back(DR_LEP_23);
   ...
   cout << "================================================================================"    << endl;
   cout << " Z1,Z2 mass windows (70-100)&(5-50)GeV                   |   " <<  NEvents[11]        << endl; 
   cout << "================================================================================"    << endl;
   cout << " 90 < m_4Mu < 130 GeV                                    |   " <<  NEvents[13]        << endl; 
   cout << "================================================================================"    << endl;
  ...
  */    
   ...
   out_sig->Write();
   // out_ZHTobb4Mu->Write();
   // out_TTZTobb4Mu->Write();
   // out_TTHTobb6Mu->Write();
   // out_ZZZbb4Mu->Write();
   // out_ZZ4Mu->Write();
   // out_sm_HTobb->Write();
   // out_sm_H4Mu->Write();
   ...
   out_sig->Close();   
   // out_ZHTobb4Mu->Close();
   // out_TTZTobb4Mu->Close();
   // out_TTHTobb6Mu->Close();
   // out_ZZZbb4Mu->Close();
   // out_ZZ4Mu->Close();
   // out_sm_HTobb->Close();
   // out_sm_H4Mu->Close();
