...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   h_phi_Za->GetYaxis()->SetTitle("Number of Events");
    ...
    // Results root file
    TFile *op_file = new TFile("/home/aya/Desktop/Pheno_Work/analysis/Results/output_demo.root", "RECREATE"); 
  ...
  /*==================================================================================*/ 
   ...
   for (Long64_t jentry = 0; jentry < nentries; jentry++) 
   {
     ...
     // Loop over all Muons, MuonLoose_size = 7
      ...
      h_DR_mu1mu2->Fill(DR_mu12);
      h_DR_mu3mu4->Fill(DR_mu34);
      h_DR_mu1mu3->Fill(DR_mu13);
      h_DR_mu2mu4->Fill(DR_mu24);
      h_DR_mu1mu4->Fill(DR_mu14);
      h_DR_mu2mu3->Fill(DR_mu23); 
      ...
      if ( MuonLoose_Charge[0] + MuonLoose_Charge[1] + MuonLoose_Charge[2] + MuonLoose_Charge[3] == 0){
		  ...
		  if ( MuonLoose_Charge[0] + MuonLoose_Charge[1] == 0){  // mu1, mu2 
              ...
              if ( MuonLoose_Charge[2] + MuonLoose_Charge[3] == 0){  // mu3, mu4 
			      ...
			      if (mZ12 > 0.) h_mZ12->Fill(mZ12);
			      if (mZ34 > 0.) h_mZ34->Fill(mZ34);
		    ...
		    if ( MuonLoose_Charge[0] + MuonLoose_Charge[2] == 0){  // mu1, mu3
				...
				if ( MuonLoose_Charge[1] + MuonLoose_Charge[3] == 0){ // mu2, mu4
					...
					if (mZ13 > 0.) h_mZ13->Fill(mZ13);
			        if (mZ24 > 0.) h_mZ24->Fill(mZ24);
			    }
			}
		    ...
		    if ( MuonLoose_Charge[0] + MuonLoose_Charge[3] == 0){  // mu1, mu4
				...
				if ( MuonLoose_Charge[1] + MuonLoose_Charge[2] == 0){ // mu2, mu3
					...
					if (mZ14 > 0.) h_mZ14->Fill(mZ14);
			        if (mZ23 > 0.) h_mZ23->Fill(mZ23);
			    }
			}
		  ...
		  //  }  
            ...
            h_mh1_ZaZb->Fill(mh1_ZaZb);
            h_pt_h1_ZaZb->Fill(pt_h1_ZaZb);
            h_eta_h1_ZaZb->Fill(eta_h1_ZaZb);
            h_phi_h1_ZaZb->Fill(phi_h1_ZaZb); 
		    ...
		    if ( nbjets > 1 ){ // I have at least 2 b jets 
                ...
                h_mb_jet_1->Fill(mb1);
                h_mb_jet_2->Fill(mb2);
                h_pt_b_jet_1->Fill(pt_b1);
                h_pt_b_jet_2->Fill(pt_b2);
                h_eta_b_jet_1->Fill(eta_b1);
                h_eta_b_jet_2->Fill(eta_b2);
                h_phi_b_jet_1->Fill(phi_b1);
                h_phi_b_jet_2->Fill(phi_b2);
                h_DR_b1b2->Fill(DR_b1b2); 
		       ...
		       //============================
                ...
                h_mh1_b1b2->Fill(mh2_b1b2);
                h_pt_h1_b1b2->Fill(pt_h2_b1b2);
                h_eta_h1_b1b2->Fill(eta_h2_b1b2);
                h_phi_h1_b1b2->Fill(phi_h2_b1b2);
		       ...
		       //=======================================//
                ...
                h_mh2_h1h1->Fill(mH_hh);
                h_pt_h2_h1h1->Fill(pt_H_hh);
                h_eta_h2_h1h1->Fill(eta_H_hh);
                h_phi_h2_h1h1->Fill(phi_H_hh);
