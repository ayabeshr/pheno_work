...
//#include "/home/aya/Videos/tree1.h"
#include "/home/aya/newtree.h"
//#include "/home/Aya/Downloads/pheno_work-main/Hhhbb4Mu_Analysis/DemoAnalyzer.h"
#include <TCanvas.h>
#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TFile* op_file = new TFile("/media/aya/LinuxSpace/Pheno_Work_2/analysis/output_demo_Hhhbb4M_BMP1.root", "RECREATE");
   ...
   // ttbar
   //TFile *input_file = new TFile("/media/aya/LinuxSpace/MyWork_Final_Samples/TTbar_BG_14TeV_SMfull_CMS_PhaseII_0PU_GEN_pythia8/TTbar_BG_14TeV_SMfull_pythia8_CMS_PhaseII_0PU_GEN-SIM.root", "READ");
   ...
   //ZZ4Mu
   //TFile *op_file = new TFile("/media/aya/LinuxSpace/Pheno_Work_2/analysis/BackGrounds/output_demo_2_ZZ4M_20210919.root", "RECREATE"); 
   ...
   //TFile *op_file = new TFile("/HEP_DATA/aya/output_demo_5_gghhbb4M_AllDiagrams_20210922.root", "RECREATE"); // adding control region cuts
  ...
  /* vector<Float_t> gen_muon_pt;
   ...
   b_Gen_Bjets    = treeI->Branch("Gen_BJets",          &gen_bjet);
   b_LooseMuons   = treeI->Branch("LooseMuons",         &loose_mu);
   b_Jets         = treeI->Branch("Jets",               &jets    );
   b_MET          = treeI->Branch("MET",                &met     );
   b_deltaR_muons = treeI->Branch("DeltaR_Muons",       &drMuons );
   b_Zmass_comb   = treeI->Branch("Zmass_Combinations", &zmass   );
   b_Za_signal    = treeI->Branch("ZaOFSignal",         &za_sig  );
   b_Zb_signal    = treeI->Branch("ZbOFSignal",         &zb_sig  );
   b_b1_signal    = treeI->Branch("bjet_1_OFSignal",    &b1_sig  );
   b_b2_signal    = treeI->Branch("bjet_2_OFSignal",    &b2_sig  );
   b_1st_Higgs_Ofsignal = treeI->Branch("1st_Higgs_OFSignal",     &smhiggs1  );
  ...
  */    
   ...
   cout << "saving..." << endl;    
   cout << "ROOT file: " << op_file << " has been created sucessfully!" << endl;
