...
// Sun Jul 18 21:22:09 2021 by ROOT version 6.18/04
// from TTree Delphes/Analysis tree
// found on file: /media/aya/AYA.HDD/MGSamples2020/DY_BG_14TeV_SMfull_GEN/DY_BG_14TeV_SMfull_pythia8_CMSPhaseII-0PU_GEN-SIM.root
//////////////////////////////////////////////////////////
...
#ifdef hh_bb_4Mu_cxx
hh_bb_4Mu::hh_bb_4Mu(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/media/aya/AYA.HDD/MGSamples2020/DY_BG_14TeV_SMfull_GEN/DY_BG_14TeV_SMfull_pythia8_CMSPhaseII-0PU_GEN-SIM.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/media/aya/AYA.HDD/MGSamples2020/DY_BG_14TeV_SMfull_GEN/DY_BG_14TeV_SMfull_pythia8_CMSPhaseII-0PU_GEN-SIM.root");
      }
...
Int_t hh_bb_4Mu::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t hh_bb_4Mu::LoadTree(Long64_t entry)
{
...
void hh_bb_4Mu::Init(TTree *tree)
{
...
void hh_bb_4Mu::Show(Long64_t entry)
{
...
Int_t hh_bb_4Mu::Cut(Long64_t entry)
{
