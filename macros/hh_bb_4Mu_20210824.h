...
// Tue Aug 24 10:25:30 2021 by ROOT version 6.18/04
// from TTree Delphes/Analysis tree
// found on file: /home/Aya/DY_BG_14TeV_SMfull_GEN/DY_BG_14TeV_SMfull_pythia8_CMSPhaseII-0PU_GEN-SIM.root
//////////////////////////////////////////////////////////

#ifndef hh_bb_4Mu_20210824_h
#define hh_bb_4Mu_20210824_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   hh_bb_4Mu_20210824(TTree *tree=0);
   virtual ~hh_bb_4Mu_20210824();
...
#ifdef hh_bb_4Mu_20210824_cxx
hh_bb_4Mu_20210824::hh_bb_4Mu_20210824(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/Aya/DY_BG_14TeV_SMfull_GEN/DY_BG_14TeV_SMfull_pythia8_CMSPhaseII-0PU_GEN-SIM.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/Aya/DY_BG_14TeV_SMfull_GEN/DY_BG_14TeV_SMfull_pythia8_CMSPhaseII-0PU_GEN-SIM.root");
      }
...
hh_bb_4Mu_20210824::~hh_bb_4Mu_20210824()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t hh_bb_4Mu_20210824::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t hh_bb_4Mu_20210824::LoadTree(Long64_t entry)
{
...
void hh_bb_4Mu_20210824::Init(TTree *tree)
{
...
Bool_t hh_bb_4Mu_20210824::Notify()
{
...
void hh_bb_4Mu_20210824::Show(Long64_t entry)
{
...
Int_t hh_bb_4Mu_20210824::Cut(Long64_t entry)
{
...
#endif // #ifdef hh_bb_4Mu_20210824_cxx
